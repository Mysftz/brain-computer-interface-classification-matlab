...
disp('SBJ00 S00:  RUNNING  | Starting CNN Test (SBJ1-15, S4-7)'); %Print in the terminal that indicates the start of the test
SBJS=fopen('/Users/mysftz/BCI/SBJ-S/SBJ1-15&S4-7.txt','r'); %Open a file outlining the all the subjects, sessions 4-7 and cell ranges for the matrix to print too
rt = tic; %Starting a timer, to measure the run time of each loop and overall test

for i=1:60 %15 subjects * sessions 4 to 7 = 60 sessions to run in total, also the file opening in line 3 contains 60 lines
    ...
    writematrix(predicted_object, '/Users/mysftz/BCI/Results/CNN_Results_S4_7.xlsx', 'Range', matrixrange); %Save results data
    writematrix(sess_accuracy, '/Users/mysftz/BCI/Results/CNN_Accuracy_S4_7.xlsx', 'Range', cellrange); %Save accuracy data
    writematrix(runtime, '/Users/mysftz/BCI/Results/CNN_RunTime_S4_7.xlsx', 'Range', cellrange); %Save run time data
...
disp('SBJ00 S00:  ENDING   | Ending CNN Test (SBJ1-15, S4-7)'); %Print in the terminal that indicates the end of the test
